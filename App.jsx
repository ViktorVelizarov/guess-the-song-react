    ...
    const getReturnedParamsFromSpotifyAuth = (hash) => {
      ...
      useEffect(() => {
        ...
        function handleLogin(){
            window.alert("IMPORTANT: Right now the app only works with my own account due to how SpotifyAPI developer mode is setup, thus unfortunately the app cant be tested without using my own account. That's because it's using the developer mode in spotifyWebAPI which allows for up to 25 predefined (by me) premium spotify users to use the app. I have only one premium account and I would have to share my login info with you to test the app :/");
